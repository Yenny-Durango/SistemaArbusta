...
<body class="bg-primary">
    ...
    <!-- Bootstrap - Proporciona funcionalidades adicionales para el desarrollo web -->
    ...
    <!-- Biblioteca para gráficos interactivos - Chart.js -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>

    <!-- Biblioteca SimpleDatatables - Para la manipulación sencilla de tablas -->
    ...
    <!-- Biblioteca SweetAlert2 - Para mostrar mensajes de alerta personalizados -->
